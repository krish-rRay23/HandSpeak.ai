...
# Prefer model from env var or the latest trained run
model_env = os.environ.get('HANDSPEAK_MODEL')
default_model = Path('models_trained/run_20260127_201733/best_model.h5')
model_path = Path(model_env) if model_env else default_model
if not model_path.exists():
    # fallback to legacy name in repo root
    model_path = Path('cnn8grps_rad1_model.h5')
    ...
    try:
        ...
        if hands:
            ...
            if handz:
                ...
                # Preprocess like training: float32 and rescale to [0,1]
